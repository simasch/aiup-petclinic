...
2. **Pet belongs to the owner**: The Owner Details view of Sofia Nowak lists exactly one pet, "Luna", of type "cat" with birth date 2023-05-14. Dates are rendered in ISO-8601 throughout the application.
