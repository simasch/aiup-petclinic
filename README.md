...
[`.claude/`](.claude) refuse to end a turn while changed code or specs are unverified, and
[ADR-010](docs/architecture/adr/ADR-010-hooks-guard-the-session.md) explains why that is a hook and not a test.
