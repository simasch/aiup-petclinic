...
5. System records the visit for the pet.
...
**Trigger:** The description field is blank (step 4).
**Flow:**
...
**Trigger:** The supplied pet id does not correspond to any pet belonging to the owner (step 2).
**Flow:**
...
**Trigger:** No owner exists for the supplied owner id (step 2).
**Flow:**
...
- A new visit record exists, linked to the pet.
...
A visit can only be booked through the owner who owns the pet; the system rejects the request if the pet id does not
